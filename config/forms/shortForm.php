...
return [
	...
	1	=> [
		...
		'hotelName', 'yearBuilt', 'yearRenovated', 'numberRooms', 'numberFloors',  'numberNonSmokingRooms',  'aaaRating',  'starRating', 'hotelTypeMulti' => ['allSuites','bAndB','allInclusive','beachfront','conventionCenter','extendedStay','ranchFarm','standardHotel','apartmentsVillas','historicProperty','motel','resortSpaLodge'], 'basicInformation' => ['streetAddress', 'city', 'stateOrProvince', 'country', 'postalCode', 'url', 'propertyCurrency', 'resDeliveryEmailPrimary', 'primaryContactNumber', 'primaryFaxNumber'],   'marketTier' => ['economy', 'midscale', 'upperMidscale', 'upper', 'upperUpscale', 'luxury']
	],


	2 =>  [

		'frontDeskArrangements','childrenPolicyText', 'generalPolicies'=> ['checkInTime','checkOutTime'], 'paymentMethods' => ['paymentMethod1','paymentMethod2','paymentMethod3','paymentMethod4','paymentMethod5','paymentMethod6','paymentMethod7'], 'familyPolicies'	=> ['familyPolicy1','familyPolicy2','familyPolicy3','familyPolicy4','familyPolicy5','familyPolicy6','familyPolicy7'], 'petPolicies'	=> ['petPolicy1','petPolicy2','petPolicy3','petPolicy4'], 'rateTypes' => ['rateTypes12']
	],

	3 => [

		'taxIncluded','serviceChargeIncluded', 

		'guaranteeDepositPolicies' => ['holdGuaranteeDeposit','reservationHeldUntilHold','numNightsCreditCardDeposit','cancellationOfArrivalHours', 'cancellationOfArrivalDays', 'cancellationCharge'],

			'cancellationPolicy'	=> ['cancellationGroup','consequenceGroup1','consequenceGroup2'], 
			...
			'rateTypes'	=> ['rateTypes16','rateTypes17','rateTypes18','rateTypes19']
		],

	4	=> [
				'hotelDescription','locationDescription','facilitiesDescription','meetingFacilitiesDescription','diningDescription','recreationDescription','areaAttractionsDescription','miscellaneousInformation',

			'amenitiesAndFacilities' => ['amenitiesAndFacilities1','amenitiesAndFacilities2','amenitiesAndFacilities3','amenitiesAndFacilities4','amenitiesAndFacilities5','amenitiesAndFacilities6','amenitiesAndFacilities7','amenitiesAndFacilities8','amenitiesAndFacilities9','amenitiesAndFacilities10','amenitiesAndFacilities11','amenitiesAndFacilities12','amenitiesAndFacilities13','amenitiesAndFacilities14','amenitiesAndFacilities15','amenitiesAndFacilities16','amenitiesAndFacilities17','amenitiesAndFacilities18','amenitiesAndFacilities19','amenitiesAndFacilities20','amenitiesAndFacilities21','amenitiesAndFacilities22','amenitiesAndFacilities23','amenitiesAndFacilities24','amenitiesAndFacilities25','amenitiesAndFacilities26','amenitiesAndFacilities27','amenitiesAndFacilities28','amenitiesAndFacilities29']
		],
