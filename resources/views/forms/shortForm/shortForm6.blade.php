@extends('layouts.formMaster', ['curPage'=>6])
...
@section('form')
	@include('partial/formOpen', ['last_page' => true])
		...
		<div class="form-container">
		    ...
		    <div class="form-row">
			    <div class="col-xs-6">
			    	{{Form::label('signature1', 'Name:') }} 
			    	{{Form::text('signature1', null, ['placeholder' => 'Insert Signature', 'class' => 'sig-date']) }}
			    </div>
			    <div class="col-xs-6">
			    	{{Form::label('signature2', 'Date:') }} 
			    	{{Form::text('signature2', null, ['placeholder' => 'Insert Date', 'class' => 'sig-date']) }}
			    </div>
			</div>
	    </div>
